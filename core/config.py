...
net_arg.add_argument(
    "--use_ggcm", type=str2bool, default=True, help=""
    "use Global Geometric Consistency Module. Default: True")
net_arg.add_argument(
    "--use_msdpm", type=str2bool, default=True, help=""
    "use Multi-Scale Dilated Perception Module. Default: True")
net_arg.add_argument(
    "--use_omrm", type=str2bool, default=True, help=""
    "use Original Motion Reference Module. Default: True")
...
train_arg.add_argument(
    "--log_suffix", type=str, default="GateMatch_enhanced", help=""
    "suffix of log dir")
train_arg.add_argument(
